    ...
    <section id="ruah" className="py-24 px-6 border-t border-b border-[#0E9A4C]/10" style={{background:'#EDE6D8'}} ref={ref}>
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }} className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="text-[0.86rem] text-[#7A7060] leading-[1.8] font-light">{t('desc')}</p>
        </motion.div>

        {/* Foto hipertermia destacada */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7, delay: 0.1 }} className="relative w-full aspect-[16/6] overflow-hidden mb-10 border border-[#0E9A4C]/15 shadow-sm">
          <Image
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="relative w-full aspect-[4/3] overflow-hidden border border-[#0E9A4C]/15 shadow-sm">
            <Image
