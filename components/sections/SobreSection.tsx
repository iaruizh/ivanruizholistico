    ...
    <section id="sobre" className="py-24 px-6" style={{background:'#F5F0E8'}} ref={ref}>
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-start">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }}>
          ...
          <div className="space-y-4 text-[0.88rem] text-[#7A7060] leading-[1.9] font-light">
          ...
          {/* Foto consultorio */}
          <div className="mt-8 relative w-full aspect-[4/3] overflow-hidden border border-[#0E9A4C]/15 shadow-sm">
            <Image
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7, delay: 0.15 }} className="flex flex-col gap-3">
          ...
          {/* Foto con esfera */}
          <div className="mt-2 relative w-full aspect-[4/3] overflow-hidden border border-[#0E9A4C]/15 shadow-sm">
            <Image
