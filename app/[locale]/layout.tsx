...
const personJsonLd = {
  ...
  description:
    'Ingeniero Mecatrónico y Terapeuta Holointegrativo. Fundador de ZANATTE Centro Holointegrativo. Creador de la experiencia RUAH.',
  ...
  sameAs: [
    'https://instagram.com/ivanaleruizh',
    'https://tiktok.com/@ivanaleruizh',
