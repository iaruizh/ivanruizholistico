...
export const metadata: Metadata = {
  ...
  description:
    'Ingeniero Mecatrónico y Terapeuta Holointegrativo. Fundador de ZANATTE. Experiencia RUAH de restauración y reconexión integral en Bogotá, Colombia.',
  keywords: [
    'terapeuta holointegrativo bogota',
    'RUAH experiencia terapeutica',
    'zanatte sanacion integral',
    'bienestar integral colombia',
  ...
  openGraph: {
    ...
    description:
      'Ingeniero Mecatrónico y Terapeuta Holointegrativo. Fundador de ZANATTE Centro Holointegrativo. Experiencia RUAH en Bogotá, Colombia.',
    images: [
      {
